...
<body>
	...
	<div id="wrapper">
		...
		<ul class="actions vertical">
			...
			<li><h5>회원탈퇴</h5></li>
			<form action="JoinOutService.do" method="post">
				<li><input type="hidden" name="user_id"
					value="${sessionScope.user_id}"></li>
				<li><input type="submit" value="회원탈퇴" class="button fit"></li>
			</form>
		</ul>
		</nav>
		<!-- Banner -->
